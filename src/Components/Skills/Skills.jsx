...
function Skills() {
  return (
    ...
    <div className="h-auto w-full flex flex-warp font-serif flex-col items-center mt-20 md:mt-6 ">
      ...
      <div className="flex justify-evenly  mt-20 md:mt-15 w-full animate-pulse font-bold font-serif md:text-2xl text-lg  text-violet-950 ">
      <p >Technical Skills </p>
        <p> Professional Skills</p>
        </div>
      <div className=" border-b-fuchsia-950 border-4 h-1 w-40 mr-150 md:block hidden"></div>
      <div className=" border-b-fuchsia-950 border-4 h-1 w-50 ml-140 md:block hidden"></div>
      </div>
      ...
      <p className="  mt-13 md:mt-3 md:px-30 px-20">
      ...
      {/* Proffesional skilss */}
        <div className="flex md:flex-row md:mr-[30px] mr-5 flex-wrap justify-between text-center h-20 w-30 md:h-100 md:w-100 mt-9 font-serif  md:mt-4">
