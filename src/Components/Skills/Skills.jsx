...
function Skills() {
  return (
    ...
    <div className="h-auto w-full flex flex-warp font-serif flex-col items-center mt-20 md:mt-6 ">
      ...
      <div className="flex justify-evenly  mt-20 md:mt-15 w-full animate-pulse font-bold font-serif md:text-2xl text-md  text-violet-950 ">
      ...
      {/* Proffesional skilss */}
        <div className="flex md:flex-row md:mr-[30px]  flex-wrap justify-between text-center h-20 w-30 md:h-100 md:w-100 mt-9 font-serif  md:mt-4">
