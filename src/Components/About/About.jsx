...
function About() {
  return (
    <div className="h-auto w-full flex flex-warp font-serif flex-col items-center mt-10  md:mt-10 ">
      ...
      <img className="lg:h-120 lg:w-120 h-80 w-80 md:mt-8 md:ml-10 sm:ml-5 mt-10 rounded-t-full "
    ...
    <button className="w-40 h-10 text-[18px] hidden md:block font-bold rounded-full text-[#ffffff] ml-30 mt-4 md:mt-5  cursor-pointer bg-gradient-to-r from-[#2c0024] to-[#c08fc0]"
      ...
      <button className="w-40 h-10 md:hidden text-[18px] font-bold rounded-full text-[#ffffff]  mt-4 cursor-pointer bg-gradient-to-r from-[#2c0024] to-[#c08fc0]"
      >Download CV</button>
</div>
</div>
