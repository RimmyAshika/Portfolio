...
function Home() {
  return (
   <div className='flex flex-row md:flex-col flex-wrap w-full h-120  '>
        <div className=' bg-gradient-to-r to-[rgb(227,163,198)]   from-[rgb(39,0,32)]  md:w-200 md:rounded-e-full md:h-100 h-70 w-90 md:mx-20 mx-8 mt-20 md:mt-40 p-15 md:p-7 '>
        ...
        <div className='md:h-130 md:w-130 h-80 w-80 md:mt-15 mt-10   '>
          <img  className="md:rounded-full rounded-t-full  md:ml-0 ml-10 flex flex-wrap flex-col" src="Images/profile.jpg" alt="" />
        </div>
   </div>
  )
}
