...
function Home() {
  return (
   <div className='flex flex-row md:flex-col flex-wrap w-full h-150  '>
        ...
        <div className='md:h-130 md:w-130 h-80 w-80 md:mt-15 mt-10   '>
          <img  className="md:rounded-full rounded-t-full md:mr-20 ml-5  mb-5 flex flex-wrap flex-col" src="./Images/profile.jpg" alt="" />
        </div>
   </div>
  )
}
